...
/* harmony import */ var _supplier_supplier_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./supplier/supplier.component */ "./src/app/supplier/supplier.component.ts");
/* harmony import */ var _supplier_supplierlist_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./supplier/supplierlist.component */ "./src/app/supplier/supplierlist.component.ts");
...
/* harmony import */ var _purchaseorder_purchaseorder_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./purchaseorder/purchaseorder.component */ "./src/app/purchaseorder/purchaseorder.component.ts");
/* harmony import */ var _purchaseorder_purchaseorderlist_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./purchaseorder/purchaseorderlist.component */ "./src/app/purchaseorder/purchaseorderlist.component.ts");
/* harmony import */ var _tradehistory_tradehistory_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./tradehistory/tradehistory.component */ "./src/app/tradehistory/tradehistory.component.ts");
/* harmony import */ var _tradehistory_tradehistorylist_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./tradehistory/tradehistorylist.component */ "./src/app/tradehistory/tradehistorylist.component.ts");
...
var routes = [
    ...
    {
        path: 'supplier',
        component: _supplier_supplier_component__WEBPACK_IMPORTED_MODULE_34__["SupplierComponent"]
    },
    {
        path: 'supplierlist',
        component: _supplier_supplierlist_component__WEBPACK_IMPORTED_MODULE_35__["SupplierlistComponent"]
    },
    {
        path: 'supplier/:id',
        component: _supplier_supplier_component__WEBPACK_IMPORTED_MODULE_34__["SupplierComponent"]
    ...
    {
        path: 'purchaseOrder',
        component: _purchaseorder_purchaseorder_component__WEBPACK_IMPORTED_MODULE_38__["PurchaseorderComponent"]
    },
    {
        path: 'purchaseOrderList',
        component: _purchaseorder_purchaseorderlist_component__WEBPACK_IMPORTED_MODULE_39__["PurchaseorderlistComponent"]
    },
    {
    ...
    {
        path: 'tradehistory',
        component: _tradehistory_tradehistory_component__WEBPACK_IMPORTED_MODULE_40__["TradehistoryComponent"]
    },
    {
        path: 'tradehistoryList',
        component: _tradehistory_tradehistorylist_component__WEBPACK_IMPORTED_MODULE_41__["TradehistorylistComponent"]
    },
    {
...
/* harmony import */ var _purchaseorder_purchaseorder_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./purchaseorder/purchaseorder.component */ "./src/app/purchaseorder/purchaseorder.component.ts");
/* harmony import */ var _purchaseorder_purchaseorderlist_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./purchaseorder/purchaseorderlist.component */ "./src/app/purchaseorder/purchaseorderlist.component.ts");
/* harmony import */ var _tradehistory_tradehistory_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./tradehistory/tradehistory.component */ "./src/app/tradehistory/tradehistory.component.ts");
/* harmony import */ var _tradehistory_tradehistorylist_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./tradehistory/tradehistorylist.component */ "./src/app/tradehistory/tradehistorylist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _supplier_supplier_component__WEBPACK_IMPORTED_MODULE_46__["SupplierComponent"],
                _supplier_supplierlist_component__WEBPACK_IMPORTED_MODULE_47__["SupplierlistComponent"],
                ...
                _purchaseorder_purchaseorder_component__WEBPACK_IMPORTED_MODULE_50__["PurchaseorderComponent"],
                _purchaseorder_purchaseorderlist_component__WEBPACK_IMPORTED_MODULE_51__["PurchaseorderlistComponent"],
                _tradehistory_tradehistory_component__WEBPACK_IMPORTED_MODULE_52__["TradehistoryComponent"],
                _tradehistory_tradehistorylist_component__WEBPACK_IMPORTED_MODULE_53__["TradehistorylistComponent"]
            ],
            imports: [
...
var BaseCtl = /** @class */ (function () {
    ...
    BaseCtl.prototype.validateMobileInput = function (event) {
        var values = event.target.value + event.key;
        if (!/^[6-9][0-9]{0,9}$/.test(values)) {
            event.preventDefault();
        }
    };
    BaseCtl.prototype.validateAlphabetInput = function (event) {
        var str = event.key;
        console.log(str);
    ...
    BaseCtl.prototype.validateAlphanumericInput = function (event) {
        var str = event.key;
        console.log(event);
        console.log(str);
    ...
    BaseCtl.prototype.validateAlphanumericInput1 = function (event) {
        console.log(event);
        var str = event.key;
        console.log(str);
        if (!/^[a-zA-Z0-9\s.,-]$/.test(str)) {
    ...
    BaseCtl.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
    ...
    BaseCtl.prototype.validateDecimalInput = function (event) {
        var str = event.key;
        console.log(event);
        if (!/^\d$|^\.$/.test(str)) {
            event.preventDefault();
    ...
    BaseCtl.prototype.validateDecimal = function (event) {
...
var EndpointServiceService = /** @class */ (function () {
    function EndpointServiceService() {
        ...
        this.PO = this.SERVER_URL + "/Po";
        this.TRADEHISTORY = this.SERVER_URL + "/TradeHistory";
    }
...
var FollowupComponent = /** @class */ (function (_super) {
    ...
    function FollowupComponent(locator, route, httpClient) {
    ...
    FollowupComponent.prototype.test = function () {
    };
    FollowupComponent.prototype.submit = function () {
        var _self = this;
        this.serviceLocator.httpService.post(this.api.save, this.form.data, function (res) {
            _self.form.message = '';
            _self.form.inputerror = {};
    ...
    FollowupComponent.prototype.onUpload = function (userform) {
        this.submit();
    };
    ...
    FollowupComponent.prototype.validateAlphabetInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^[a-zA-Z\s]*$/.test(str)) {
            event.preventDefault();
    ...
    FollowupComponent.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
...
var FollowuplistComponent = /** @class */ (function (_super) {
    ...
    FollowuplistComponent.prototype.validateMobileInput = function (event) {
        var values = event.target.value + event.key;
        if (!/^[6-9][0-9]{0,9}$/.test(values)) {
            event.preventDefault();
        }
    };
    FollowuplistComponent.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
    ...
    FollowuplistComponent.prototype.validateAlphabetInput = function (event) {
        console.log(event);
        var str = event.key;
        console.log(str);
        if (!/^[a-zA-Z\s]*$/.test(str)) {
...
/***/ "./src/app/purchaseorder/purchaseorder.component.css":
/*!***********************************************************!*\
  !*** ./src/app/purchaseorder/purchaseorder.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3B1cmNoYXNlb3JkZXIvcHVyY2hhc2VvcmRlci5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/purchaseorder/purchaseorder.component.html":
/*!************************************************************!*\
  !*** ./src/app/purchaseorder/purchaseorder.component.html ***!
  \************************************************************/
/*! no static exports found */
...
var PurchaseorderComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PurchaseorderComponent, _super);
    function PurchaseorderComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.PURCHASEORDER, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
        _this.getKey = false;
    ...
    PurchaseorderComponent.prototype.parseDate = function (dateString) {
        if (dateString) {
            return new Date(dateString);
        }
        return null;
    };
    PurchaseorderComponent.prototype.test = function () {
    };
    ...
    PurchaseorderComponent.prototype.onUpload = function (userform) {
        this.submit();
    };
    PurchaseorderComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
    ...
    PurchaseorderComponent.prototype.validateAlphabetInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^[a-zA-Z\s]*$/.test(str)) {
            event.preventDefault();
    ...
    PurchaseorderComponent.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
    ...
    PurchaseorderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./purchaseorder.component.html */ "./src/app/purchaseorder/purchaseorder.component.html"),
            styles: [__webpack_require__(/*! ./purchaseorder.component.css */ "./src/app/purchaseorder/purchaseorder.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])
...
/***/ "./src/app/purchaseorder/purchaseorderlist.component.css":
/*!***************************************************************!*\
  !*** ./src/app/purchaseorder/purchaseorderlist.component.css ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3B1cmNoYXNlb3JkZXIvcHVyY2hhc2VvcmRlcmxpc3QuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/purchaseorder/purchaseorderlist.component.html":
/*!****************************************************************!*\
  !*** ./src/app/purchaseorder/purchaseorderlist.component.html ***!
  \****************************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  #nnn {\r\n    background: none;\r\n    border: none;\r\n    cursor: pointer;\r\n  }\r\n\r\n  .panel-heading {\r\n    height: 50px;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n  }\r\n\r\n  .search-inputs {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .search-inputs .form-control,\r\n  .search-inputs .btn {\r\n    margin-bottom: 10px;\r\n  }\r\n\r\n  .content-wrapper {\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: auto;\r\n    height: 105vh;\r\n    padding: 20px;\r\n  }\r\n\r\n  .table-responsive {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .table th,\r\n  .table td {\r\n    vertical-align: middle;\r\n  }\r\n</style>\r\n\r\n<div class=\"content-wrapper\">\r\n  <div class=\"container-fluid\">\r\n    <div class=\"panel panel-primary\">\r\n      <div class=\"panel-heading\">\r\n        <h1 class=\"text-primary font-weight-bold\">{{ 'Purchase Order List' | translate }}</h1>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Search Inputs Section -->\r\n    <div class=\"row search-inputs\">\r\n      <div class=\"col-md-3\">\r\n        <input type=\"date\" class=\"form-control\" [(ngModel)]=\"form.searchParams.orderDate\" (ngModelChange)=\"formatDate($event)\" placeholder=\"{{ 'Search orderDate ' | translate }}\">\r\n      </div>\r\n\r\n      <div class=\"col-md-3\">\r\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.totalQuantity\" placeholder=\"{{ 'Search totalQuantity' | translate }}\" (keydown)=\"filterInput($event, 'errorMessgetotalQuantity', 10, 'int ')\">\r\n        <span *ngIf=\"errorMessgetotalQuantity\" style=\"color: red;\">{{ errorMessgetotalQuantity }}</span>\r\n      </div>\r\n\r\n      <div class=\"col-md-3\">\r\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.totalCost\" placeholder=\"{{ 'Search totalCost' | translate }}\" (keydown)=\"filterInput($event, 'errorMessgetotalCost', 10, 'int')\">\r\n        <span *ngIf=\"errorMessgetotalCost\" style=\"color: red;\">{{ errorMessgetotalCost }}</span>\r\n      </div>\r\n\r\n      <div class=\"col-md-3\">\r\n        <select class=\"form-control\" name=\"productId\" [(ngModel)]=\"form.searchParams.productId\" aria-label=\"ngSelected\">\r\n          <option [ngValue]=\"null\">{{ 'Select Category' | translate }}</option>\r\n          <option *ngFor=\"let obj of form.preload.productList | keyvalue\" [ngValue]=\"obj.key\">{{ obj.value }}</option>\r\n        </select>\r\n      </div>\r\n    </div>\r\n\r\n    <div class=\"row mt-2 justify-content-center\">\r\n      <div class=\"col-md-2\">\r\n        <button (click)=\"submit()\" class=\"btn btn-primary btn-block\">{{ 'Search' | translate }}</button>\r\n      </div>\r\n      <div class=\"col-md-2\">\r\n        <button (click)=\"forward('/purchaseOrder')\" class=\"btn btn-success btn-block\">{{ 'Add Purchase Order' | translate }}</button>\r\n      </div>\r\n      <div class=\"col-md-2\">\r\n        <button (click)=\"deleteMany()\" class=\"btn btn-danger btn-block\">{{ 'Delete' | translate }}</button>\r\n      </div>\r\n    </div>\r\n\r\n    <div *ngIf=\"form.error || form.message\" class=\"row mt-2 justify-content-center\">\r\n      <div class=\"col-md-6\">\r\n        <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\r\n          <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n          {{ form.message }}\r\n        </div>\r\n        <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible\">\r\n          <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n          {{ form.message }}\r\n        </div>\r\n      </div>\r\n    </div>\r\n\r\n    <div class=\"table-responsive mt-3\">\r\n      <table class=\"table table-bordered table-hover font-weight-bold text-dark\">\r\n        <thead class=\"thead-dark text-uppercase\">\r\n          <tr align=\"center\">\r\n            <th>\r\n              <input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" name=\"list_name\" (change)=\"checkUncheckAll($event)\">\r\n            </th>\r\n            <th>{{ 'S.No' }}</th>\r\n            <th>{{ 'TotalCost' }}</th>\r\n            <th>{{ 'TotalQuantity' }}</th>\r\n            <th>{{ 'OrderDate' }}</th>\r\n            <th>{{ 'Product' }}</th>\r\n            <th>{{ 'Edit' }}</th>\r\n          </tr>\r\n        </thead>\r\n        <tbody>\r\n          <tr *ngFor=\"let m of form.list; let i = index\" align=\"center\">\r\n            <td>\r\n              <input type=\"checkbox\" #checkboxes (change)=\"checklistUpdate()\" name=\"list_name\" [id]=\"m.id\">\r\n            </td>\r\n            <td>{{ (form.pageNo * 5) + i + 1 }}</td>\r\n            <td>{{ m.totalCost }}</td>\r\n            <td>{{ m.totalQuantity }}</td>\r\n            <td>{{ convertToLocalDate(m.orderDate) }}</td>\r\n            <td>{{ form.preload.productList[m.productId] }}</td>\r\n            <td>\r\n              <button class=\"fa fa-edit text-primary\" id=\"nnn\" (click)=\"forward('/purchaseOrder/' + m.id)\"></button>\r\n            </td>\r\n          </tr>\r\n        </tbody>\r\n      </table>\r\n    </div>\r\n\r\n    <div class=\"d-flex justify-content-between mt-3\">\r\n      <button (click)=\"previous()\" [disabled]=\"form.pageNo == 0\" class=\"btn btn-info\">{{ 'Previous' | translate }}</button>\r\n      <div *ngIf=\"form.list.length == 0\">\r\n        <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/purchaseOrderList']\" (click)=\"exit()\">{{ 'Back' | translate }}</a>\r\n      </div>\r\n      <button (click)=\"next()\" [disabled]=\"nextList == 0\" class=\"btn btn-info\">{{ 'Next' | translate }}</button>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>\r\n"

/***/ }),

/***/ "./src/app/purchaseorder/purchaseorderlist.component.ts":
/*!**************************************************************!*\
  !*** ./src/app/purchaseorder/purchaseorderlist.component.ts ***!
  \**************************************************************/
/*! exports provided: PurchaseorderlistComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PurchaseorderlistComponent", function() { return PurchaseorderlistComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _base_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../base-list.component */ "./src/app/base-list.component.ts");
/* harmony import */ var _service_locator_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service-locator.service */ "./src/app/service-locator.service.ts");
...
var PurchaseorderlistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PurchaseorderlistComponent, _super);
    function PurchaseorderlistComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.PURCHASEORDER, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
    ...
    PurchaseorderlistComponent.prototype.validateMobileInput = function (event) {
        var values = event.target.value + event.key;
        if (!/^[6-9][0-9]{0,9}$/.test(values)) {
            event.preventDefault();
        }
    };
    PurchaseorderlistComponent.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
    ...
    PurchaseorderlistComponent.prototype.validateAlphabetInput = function (event) {
        console.log(event);
        var str = event.key;
        console.log(str);
        if (!/^[a-zA-Z\s]*$/.test(str)) {
    ...
    PurchaseorderlistComponent.prototype.submit = function () {
        this.form.pageNo = 0;
        this.search();
    };
    PurchaseorderlistComponent.prototype.search = function () {
        this.form.searchMessage = null;
        _super.prototype.search.call(this);
    };
    PurchaseorderlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-purchaseorderlist',
            template: __webpack_require__(/*! ./purchaseorderlist.component.html */ "./src/app/purchaseorder/purchaseorderlist.component.html"),
            styles: [__webpack_require__(/*! ./purchaseorderlist.component.css */ "./src/app/purchaseorder/purchaseorderlist.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])
...
var SupplierComponent = /** @class */ (function (_super) {
    ...
    SupplierComponent.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
...
var SupplierlistComponent = /** @class */ (function (_super) {
    ...
    SupplierlistComponent.prototype.validateMobileInput = function (event) {
        var values = event.target.value + event.key;
        if (!/^[6-9][0-9]{0,9}$/.test(values)) {
            event.preventDefault();
        }
    };
    SupplierlistComponent.prototype.validateNumericInput = function (event) {
        var str = event.key;
        console.log(str);
        if (!/^\d$/.test(str)) {
            event.preventDefault();
    ...
    SupplierlistComponent.prototype.validateAlphabetInput = function (event) {
        console.log(event);
        var str = event.key;
        console.log(str);
        if (!/^[a-zA-Z\s]*$/.test(str)) {
...
/***/ "./src/app/tradehistory/tradehistory.component.css":
/*!*********************************************************!*\
  !*** ./src/app/tradehistory/tradehistory.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3RyYWRlaGlzdG9yeS90cmFkZWhpc3RvcnkuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/tradehistory/tradehistory.component.html":
/*!**********************************************************!*\
  !*** ./src/app/tradehistory/tradehistory.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/tradehistory/tradehistory.component.ts":
/*!********************************************************!*\
  !*** ./src/app/tradehistory/tradehistory.component.ts ***!
  \********************************************************/
...
var TradehistoryComponent = /** @class */ (function () {
    ...
    TradehistoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-tradehistory',
            template: __webpack_require__(/*! ./tradehistory.component.html */ "./src/app/tradehistory/tradehistory.component.html"),
            styles: [__webpack_require__(/*! ./tradehistory.component.css */ "./src/app/tradehistory/tradehistory.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
/***/ "./src/app/tradehistory/tradehistorylist.component.css":
/*!*************************************************************!*\
  !*** ./src/app/tradehistory/tradehistorylist.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3RyYWRlaGlzdG9yeS90cmFkZWhpc3RvcnlsaXN0LmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/tradehistory/tradehistorylist.component.html":
/*!**************************************************************!*\
  !*** ./src/app/tradehistory/tradehistorylist.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = "<p>\r\n  tradehistorylist works!\r\n</p>\r\n"

/***/ }),

/***/ "./src/app/tradehistory/tradehistorylist.component.ts":
/*!************************************************************!*\
  !*** ./src/app/tradehistory/tradehistorylist.component.ts ***!
  \************************************************************/
/*! exports provided: TradehistorylistComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TradehistorylistComponent", function() { return TradehistorylistComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var TradehistorylistComponent = /** @class */ (function () {
    function TradehistorylistComponent() {
    }
    TradehistorylistComponent.prototype.ngOnInit = function () {
    };
    TradehistorylistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-tradehistorylist',
            template: __webpack_require__(/*! ./tradehistorylist.component.html */ "./src/app/tradehistory/tradehistorylist.component.html"),
            styles: [__webpack_require__(/*! ./tradehistorylist.component.css */ "./src/app/tradehistory/tradehistorylist.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], TradehistorylistComponent);
    return TradehistorylistComponent;
}());
...
module.exports = __webpack_require__(/*! D:\workspace\p10-docker\ORSProject10-UI\src\main.ts */"./src/main.ts");
